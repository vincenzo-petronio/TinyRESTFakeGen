...
public class UserResource {
    ...
    /**
     * Retrieves representation of an instance of it.localhost.app.web.tinyrestfakegen.uri.UserResource
    ...
    public String getJson() {
        ...
        try {
            json = gson.toJson(dao.getAllUsers().stream().findFirst().get());
